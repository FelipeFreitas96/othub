...
export function parseCharacterList(msg: InputMessage, clientVersion: number | string = 860) {
    const characters: any[] = []
    const version = typeof clientVersion === 'string' ? parseInt(clientVersion, 10) : clientVersion || 860
 ...
 */
export function parseLoginError(msg: InputMessage) {
    try {
