...
const PROTOCOL_VERSION_MAP: Record<number, number> = {
    980: 971,
    981: 973,
    982: 974,
    983: 975,
...
export interface ProtocolInfo {
    ...
    clientVersionFeature: boolean
    contentRevision: boolean
    authenticator: boolean
    sessionKey: boolean
    challengeOnLogin: boolean
    messageSizeCheck: boolean
    sequencedPackets: boolean
}

export function getProtocolInfo(clientVersion: number | string): ProtocolInfo {
