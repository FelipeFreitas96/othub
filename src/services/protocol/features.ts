...
function applyFeatures(version: number) {
...
export function setClientVersion(version: number | string) {
    const parsed = typeof version === 'string' ? parseInt(version, 10) : version
    currentVersion = Number.isFinite(parsed) && parsed > 0 ? (parsed as number) : 860
    resetFeatures()
